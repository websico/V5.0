...
//	Get containing form of an object
//	--------------------------------
//	(usually an input element)
//	--------------------------
function ws_getParentForm(obj) {	// shouls be replaced by .form attribute of the element
	while (obj.tagName != 'FORM' && obj.parentNode)
		obj = obj.parentNode;
	return obj;
}
